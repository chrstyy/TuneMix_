...
class WidgetRecoUser extends StatelessWidget {
 WidgetRecoUser({super.key});
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SongDetailScreen(songId: song.id), // Pass the selected song ID to detail screen
                          ),
                        );
                      },
                      child: Padding(
