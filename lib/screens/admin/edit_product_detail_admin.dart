    ...
    try {
      ...
      if (_image != null) {
        ...
        final storageRef = FirebaseStorage.instance
            ...
            .child('${DateTime.now().millisecondsSinceEpoch}${path.extension(_image!.path)}');
      ...
      Song newSong = Song(
        ...
        songArtist: _creatorController.text,
        genre: _genreController.text,
        description: _lyricsController.text,
        imageSong: imageUrl,
        price: 0, // You can adjust this if necessary
      );

      // Save data to Firestore
      await FirebaseFirestore.instance.collection('songs').add(newSong.toFirestore());
